    ...
    <div class="list_container">
        <div class="List_of_ActualTopics">
            <ul>
                ...
                <li>Создание технологии, помогающей восстанавливать функции мозга.</li>
                <li>Научить нейросети распознавать опухоли.</li>
                <li>Создание полноценного портала для школьников и студентов.</li>
                <li>Создание платформы, которая в итоге решила бы проблемы профориентации для школьников.</li>
                <li>Создание приложение, которое поможет генерировать дизайн интерьера помещений.</li>
                <li>Создание Smart-устройства для дома</li>
                <li>Создание стартапа, ориентированного на сокращение пищевых отходов в вашем регионе.</li>
                <li>Проект анонимной психологической помощи для подростков и взрослых — аналог телефона доверия.</li>
                <li>Создание приложения с дополненной реальностью для экскурсий по городу.</li>
            </ul>
        </div>
